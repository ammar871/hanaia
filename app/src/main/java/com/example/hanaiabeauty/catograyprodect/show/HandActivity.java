...
public class HandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ref = database.getReference().child("شنط يد نسائية");
        binding.list.setLayoutManager(new GridLayoutManager(HandActivity.this, 2));
        binding.list.setHasFixedSize(true);
        binding.back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HandActivity.this, HomeActivity.class));
                finish();
            }
        });
        loadData();
    ...
    private void loadData() {
        ...
        Ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adpter = new AdpterHorsintal(list, HandActivity.this);
