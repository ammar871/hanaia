...
public class MotfarkatActivity extends AppCompatActivity {
    FirebaseDatabase database;
    DatabaseReference Ref;
    ActivityMotfarkatBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_motfarkat);
        list = new ArrayList<>();

        database = FirebaseDatabase.getInstance();
        Ref =  database.getReference().child("متفرقات");
        binding.list.setLayoutManager(new GridLayoutManager(MotfarkatActivity.this, 2));
        binding.list.setHasFixedSize(true);
        binding.back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MotfarkatActivity.this, HomeActivity.class));
                finish();
            }
        });
        loadData();
    ...
    private void loadData() {
        ...
        Ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adpter = new AdpterHorsintal(list, MotfarkatActivity.this);
