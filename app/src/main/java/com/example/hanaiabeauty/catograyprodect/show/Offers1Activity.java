...
import com.example.hanaiabeauty.databinding.ActivityOffers1Binding;
...
public class Offers1Activity extends AppCompatActivity {
    FirebaseDatabase database;
    DatabaseReference Ref;
    ActivityOffers1Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_offers1);
        list = new ArrayList<>();

        database = FirebaseDatabase.getInstance();
        Ref = database.getReference().child("عروض 1");
        binding.list.setLayoutManager(new GridLayoutManager(Offers1Activity.this, 2));
        binding.list.setHasFixedSize(true);
        binding.back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Offers1Activity.this, HomeActivity.class));
                finish();
            }
        });
        loadData();
    ...
    private void loadData() {
        ...
        Ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adpter = new AdpterHorsintal(list, Offers1Activity.this);
